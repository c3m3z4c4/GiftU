...
const SearchRight = () => {
        ...
        return ( <
            >
            <
            WrapperRight > { mutationLoading ? < Loading / > : null } {
                mutationError
                    ?
                    ...
                    intenta de nuevo : ( < /ErrorWrapper>: < >
                        ...
                        <
                        Textform > ¿Cómo se < Span primary > llama < /Span>esa persona{" "} <
                        Span > especial < /Span> ? <
                        /Textform> <
                        InputRS value = { form.name }
                        placeholder = "nombre"
                        name = "name"
                        type = "text"
                        ...
                        <
                        Textform > ¿Cuál es < Span > la < /Span> ocasión? <
                        /Textform> <
